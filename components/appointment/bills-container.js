...
const columns = [
  { header: "No", key: "no", className: "hidden md:table-cell" },
  { header: "Service", key: "service" },
  { header: "Date", key: "date", className: "" },
  { header: "Quantity", key: "qnty", className: "hidden md:table-cell" },
  { header: "Unit Price", key: "price", className: "hidden md:table-cell" },
  { header: "Total Cost", key: "total", className: "" },
  { header: "Action", key: "action", className: "hidden xl:table-cell" },
];

export const BillsContainer = async ({ id }) => {
