...
// All props are JS objects now, not interfaces/types
...
// SwitchInput is just plain JS, so props destructured without typing
export const SwitchInput = ({ data, setWorkSchedule }) => {
