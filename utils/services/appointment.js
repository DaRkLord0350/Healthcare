...
// Query builder for filtering appointments
const buildQuery = (id, search) => {
  // Search conditions if search string exists
...
// GET ALL (filtered & paginated) APPOINTMENTS
export async function getPatientAppointments({ page, limit, search, id }) {
  try {
...
// GET SINGLE APPOINTMENT (WITH MEDICAL RECORDS)
export async function getAppointmentWithMedicalRecordsById(id) {
  try {
    if (!id) {
      return {
        success: false,
