...
// Appointment status strings
const APPOINTMENT_STATUSES = ["PENDING", "SCHEDULED", "COMPLETED", "CANCELLED"];
...
export const processAppointments = async (appointments) => {
...
export async function getPatientDashboardStatistics(id) {
  try {
    if (!id) {
      return {
        success: false,
...
export async function getPatientFullDataById(id) {
  try {
